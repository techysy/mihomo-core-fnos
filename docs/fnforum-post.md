...
> 让飞牛 NAS 变成全家的**科学上网网关** + 配合 MetaCubeXD 面板优雅管理节点

---

## 📦 简介

**Mihomo Core** 是飞牛 fnOS 上的一个**独立 mihomo（Clash Meta）内核代理服务**，开机自启，不占用 App Center 面板资源。配合 **MetaCubeXD** 面板即可添加/管理节点，轻松把 NAS 打造成局域网代理网关。
